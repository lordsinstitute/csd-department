...
CHART_PATH = os.path.join(PROJECT_ROOT, "outputs", "eth_chart_data.csv")
OUTPUT_PATH = os.path.join(PROJECT_ROOT, "outputs", "eth_prediction.csv")

# --- Load ETH chart data ---
df = pd.read_csv(CHART_PATH)

if df.empty or "normalized_price" not in df.columns:
    raise ValueError("ETH chart data invalid or missing")
...
print("✅ ETH Prediction Saved:", OUTPUT_PATH)
print(pred_df)